...
public class AuctionModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(int id)
    {
        ...
        // *** NUOVO: Controlla se mancano meno di 10 secondi alla fine ***
        var timeRemaining = (auction.EndDate - DateTime.Now).TotalSeconds;
        if (timeRemaining > 0 && timeRemaining <= 10)
        {
            // Estendi l'asta di 10 secondi
            auction.EndDate = auction.EndDate.AddSeconds(10);
            TempData["TimeExtended"] = true;
